...
// LogData is an autogenerated mock type for the LogData type
type LogData struct {
	mock.Mock
}

// AddLogData provides a mock function with given fields: newLog
func (_m *LogData) AddLogData(newLog logs.Core) error {
...
// GetLogData provides a mock function with given fields: id, page
func (_m *LogData) GetLogData(id int, page int) ([]logs.Core, error) {
