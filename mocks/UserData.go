...
// UserData is an autogenerated mock type for the UserService type
type UserData struct {
	mock.Mock
}

// ProfileData implements users.UserData
func (*UserData) ProfileData(id int) (users.Core, error) {
	panic("unimplemented")
}

// DeleteSrv provides a mock function with given fields: id
...
// GetMentorSrv provides a mock function with given fields:
...
// LoginSrv provides a mock function with given fields: email, password
func (_m *UserData) LoginData(email string) (users.Core, error) {
	...
	if rf, ok := ret.Get(1).(func(string) users.Core); ok {
		r1 = rf(email)
	} else {
...
// RegisterSrv provides a mock function with given fields: newUser
...
// UpdateUserSrv provides a mock function with given fields: id, newUser
